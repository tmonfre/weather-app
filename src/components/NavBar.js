        ...
        return (
			<div id="navbar-container">
                ...
                <div id="button-area">
                    ...
                    <a href="https://www.linkedin.com/in/thomas-monfre-0b1a50164/" target="_blank" rel="noopener noreferrer"><img src={require("../assets/linkedin.png")} alt="LinkedIn logo"></img></a>
                </div>
